  ...
  const socialLinks = [
    {
      href: "#",
      icon: (
        <svg className="w-5 h-5 text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors" viewBox="0 0 24 24" fill="currentColor">
